$(document).ready(function() {
    ...
    function conditional_annotation(){
        if(document.getElementById('annotation').checked) {
            $("#species_panel").show();
            $("#annotation1").show();
            $("#annotation2").show();
        } else {
    ...
    $('#annotation').click(conditional_annotation)
            ...
            request = $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.status === "OK") {
                        hideErrorPanels();
                        if (guest == 1) {
                            $('#upload-button-text').text('Sorry, guest cannot upload')
                        }else{
