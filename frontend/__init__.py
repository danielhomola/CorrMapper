import os, datetime
from flask import Flask, g, url_for, redirect, request, abort
...
if not app.debug:
    ...
    mail_handler = SMTPHandler(mailhost=server, fromaddr=MAIL_DEFAULT_SENDER,
                               toaddrs=ADMINS, subject='CorrMapper error',
    ...
    log_path = os.path.join(app.config['ROOTDIR'], 'logs', 'CorrMapper.log')
    ...
    app.logger.info('CorrMapper started')
