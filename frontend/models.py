...
class User(db.Model, UserMixin):
    ...
    dashboard_intro = db.Column(db.Integer, default=0)
    profile_intro = db.Column(db.Integer, default=0)
    vis_intro = db.Column(db.Integer, default=0)
    vis_genomic_intro = db.Column(db.Integer, default=0)
...
class Studies(db.Model):
    ...
    annotation = db.Column(db.Boolean())
    species = db.Column(db.String(55))
    dataset1 = db.Column(db.String(255))
    annotation1 = db.Column(db.String(255))
    dataset1_type = db.Column(db.String(30))
    autocorr = db.Column(db.Boolean())
    dataset2 = db.Column(db.String(255))
    annotation2 = db.Column(db.String(255))
    dataset2_type = db.Column(db.String(30))
    fs = db.Column(db.Boolean())
    metadata_file = db.Column(db.String(255))
    metadata_cols = db.Column(db.String(1000))
...
class Analyses(db.Model):
    ...
    fs = db.Column(db.Boolean())
    fs_method = db.Column(db.String(30))
    fs_col = db.Column(db.String(255))
    discard_overlap = db.Column(db.Boolean())
    constrain_corr = db.Column(db.Boolean())
    constrain_dist = db.Column(db.Integer)
    multi_corr_method = db.Column(db.String(30))
    alpha_val = db.Column(db.Float())
    lambda_val = db.Column(db.Float())
